...
const MESSAGE_PAIRS = {
  ...
  'viewer.guide.shortcut.back': ['Back / leave drilldown', '返回 / 离开下钻'],
  'viewer.drilldown.descend': ['Descend', '进入内部'],
  'viewer.drilldown.back': ['Back', '返回'],
  'viewer.drilldown.stale': ['child diagram is stale', '子图过期'],
  'viewer.drilldown.stale.title': ['Child diagram is stale', '子图过期'],
  'viewer.drilldown.expectedId': ['expected id:', '预期 id：'],
  'viewer.drilldown.actualId': ['actual id:', '实际 id：'],
  'viewer.drilldown.expectedSha': ['expected spec sha256:', '预期 spec sha256：'],
  'viewer.drilldown.actualSha': ['actual:', '实际：'],
  'viewer.drilldown.reason': ['reason:', '原因：'],
  'viewer.drilldown.repair': ['archify bundle <dir>', 'archify bundle <dir>'],
  'viewer.dive.opening': ['Opening “{label}”…', '正在打开“{label}”…'],
  'viewer.locate.filesInside': ['{count} FILES TOUCHED INSIDE', '内部命中 {count} 个文件'],
  ...
  'viewer.nav.dive': ['Auto zoom-dive', '自动缩放深入'],
  'viewer.nav.dive.title': ['Auto zoom-dive (Z)', '自动缩放深入（Z）'],
  'viewer.nav.dive.short': ['DIVE', '深潜'],
