    ...
    Archify.dive = (function () {
      ...
      // Route Probe picking/result, Semantic Lens open and Presentation are
      // deliberate, exclusive exploration modes — genuinely incompatible
      // with an automatic descend. Intent Trace's own "active" node is
      ...
      function blockingActive() {
        ...
        if (Archify.presentation && Archify.presentation.active && Archify.presentation.active()) return true;
        return false;
      }
